...
%% 2
coeff_mat = [1/2, 1/2, 0, 1; 0, 1/2, 1/2, 1; 0, 1/4, 3/4, 1; 0, 1, 0, 1];

coeff_mat1 = [1/2, 1/2, 0, 1; 0, 1/2, 1/2, 1; 0, 1/4, 3/4, 1; 0, 0, 0, 1];
%coeff_mat = [1, 0, 1, 0; 1, 0, 0, 1; 1, 1, 0, 0; 1, 0, 1/2, 1/2];
